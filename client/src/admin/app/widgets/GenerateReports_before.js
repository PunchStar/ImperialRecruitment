        ...
        {pdfUsers.userData.map((user, index) => {
            ...
            return (
              <View style={{marginTop: 20}} key={index}>
                ...
                <Text style={styles.text}><Text style={styles.subtitle}>{"State Drivers License or ID:  "}</Text>{ documentStates[driverLicense.state] } </Text >
                <Text style={styles.text}><Text style={styles.subtitle}>{"Social Security Card:  "}</Text>{ documentStates[social.state] } </Text >
                <Text style={styles.text}><Text style={styles.subtitle}>{"USA Passport (showing all 4 corners):  "}</Text>{ documentStates[passport.state] } </Text >
                <Text style={styles.text}><Text style={styles.subtitle}>{"2 year Most Recent Tax Returns (Full):  "}</Text>{ documentStates[tax.state] } </Text >
                <Text style={styles.text}><Text style={styles.subtitle}>{"3 months Most Recent Bank Statements:  "}</Text>{ documentStates[statement.state] } </Text >
                <Text style={styles.text}><Text style={styles.subtitle}>{"Utility Bill:  "}</Text>{ documentStates[utility.state] } </Text >
                <Text style={styles.text}><Text style={styles.subtitle}>{"Mobile Phone Bill:  "}</Text>{ documentStates[phoneBill.state] } </Text >
                <Text style={styles.text}><Text style={styles.subtitle}>{"Any additional documents:  "}</Text>{ documentStates[additionalDoc.state] } </Text >
              </View>
            )
        })}
      </View>
...
function GenerateReports(props) {
  ...
  return (
    <>
      <div className="kt-portlet kt-portlet--height-fluid" style={{border: "1px solid #ddd"}}>
