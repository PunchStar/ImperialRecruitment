...
export default function MyActivity() {
  ...
  return (
    <div className="kt-widget12" style={{backgroundColor: "white", padding: 20}}>
      <div className="kt-widget12__content">
        <h2 style={{textAlign: "center", marginBottom: 60}}>My Activity</h2>
        ...
        <div className="kt-widget12__item" style={{marginTop: 30}}>
          <div className="kt-widget12__info">
      ...
      <div className="kt-widget12__chart" style={{ height: "0px" }}>
        <canvas
          ref={ref}
          width={683}
          height={312}
