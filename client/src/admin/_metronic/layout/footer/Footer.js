  ...
  render() {
    ...
    return (
        ...
        >
          ...
          <div className="kt-footer__bottom">
            <div className={`kt-container ${footerContainerClasses}`}>
              <div className="kt-footer__wrapper" style={{display: "flex"}}>
                <div className="kt-footer__menu" style={{marginLeft: "auto", marginRight: "auto"}}>
                  Lotus is encrypted and secured with Bank Level Encryption.
                  <Link to="http://keenthemes.com/metronic">Terms and Conditions</Link> &nbsp;&nbsp;&nbsp;|
                  <Link to="http://keenthemes.com/metronic">Privacy Policy</Link> &nbsp;&nbsp;&nbsp;|
                  <Link to="http://keenthemes.com/metronic">Contact</Link>
                </div>
              </div>
            </div>
          </div>
