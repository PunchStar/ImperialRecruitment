...
class HMenu extends React.Component {
    ...
    render() {
        ...
        const items = [
            { title:"Dashboards", root:true, alignment:"left", page:"dashboard", translate:"MENU.DASHBOARD" },
            { title:"All Companies", root:false, alignment:"left", page:"dashboard", translate:"MENU.DASHBOARD" },
            { title:"Accounting", root:true, alignment:"left", page:"dashboard", translate:"MENU.DASHBOARD" },
            { title:"Page Editor", root:true, alignment:"left", page:"dashboard", translate:"MENU.DASHBOARD" },
        ];
        return (
            <>
                <button
